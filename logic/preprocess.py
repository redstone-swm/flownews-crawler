...
USER_TEMPLATE = (
    ...
    "주어진 기사를 읽고 Ko-SBERT 전처리에 적합하면서도 가독성이 높은 형태로 150토큰 이내의 한국어 요약문을 작성하세요. "
    "요약은 반드시 사실 중심으로 하며, 불필요한 수식어나 추측 표현을 사용하지 마세요. "
    "출력 형식: "
    "문단은 두 부분으로 나누어 작성합니다. "
    "1) 첫 문단: 기사 전체의 주요 사건, 이슈 또는 결과를 간결히 요약. "
    "2) 두 번째 문단: 배경, 수치, 인물, 원인·영향 등 구체적 사실 정보 요약. "
